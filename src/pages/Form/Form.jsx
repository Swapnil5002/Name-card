                ...
                <h3 className="title">REGISTRATION FORM</h3>
                    <div className="sub-container">
                        <div className="name-container">
                            <p>Name:</p>
                            <input name="name" type="text" placeholder="Name..." value={this.state.name} onChange={this.handleOnchange}/>
                        </div>
                        ...
                        <div className="phone-container">
                            ...
                            <label><FontAwesomeIcon icon={faPlus} onClick={this.handleaddPhone}/></label>
                            <label><FontAwesomeIcon icon={faTimes} onClick={this.handledeletePhone}/></label>
                            {this.state.addPhone ? <p><input name="phone" type="text" placeholder=""/></p> : "" }
                        </div>
